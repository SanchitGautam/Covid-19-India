...
function InfoBox({ active, c, t, title, cases, total, update }) {
  return (
    <div className="infoBox">
      <Card
        className={`infoBox ${active && c === 1 && "infoBox__1"} ${
          active && c === 2 && "infoBox__2"
        } ${active && c === 3 && "infoBox__3"} ${t === 1 && "info__1"} ${
          t === 2 && "info__2"
        } ${t === 3 && "info__3"}`}
      >
        <CardContent>
          ...
          <Typography>
            <AnimatedNumber
              className={`infoBox__cases ${t === 1 && "cases1"} ${
                t === 2 && "cases2"
              } ${t === 3 && "cases3"}`}
              value={cases}
          ...
          <Typography>
            <AnimatedNumber
              className={`infoBox__total ${t === 1 && "cases1"} ${
                t === 2 && "cases2"
              } ${t === 3 && "cases3"}`}
              value={total}
